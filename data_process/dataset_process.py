...
class Process_Dataset:
    def __init__(self, dataset, batch_size, data_path, seq_len, label_len, pred_len, features, target, cols, freq,
                 timeenc, inverse):
...
if __name__ == "__main__":
    dataset = Process_Dataset(dataset="ETTh1", data_path= os.path.join(ETT_PATH_DIR,"ETTh1.csv"), seq_len = 24 * 4 * 4, label_len = 24 * 4, pred_len = 24 * 4, features ='S', target='OT', cols=None, freq = 'h',
