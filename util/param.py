...
ECL_PRED_AUTOFORMER_PATH = path_parse(
    "../submodule/autoformer/results/ECL_96_96_Autoformer_custom_ftM_sl96_ll48_pl24_dm512_nh8_el2_dl1_df2048_fc3_ebtimeF_dtTrue_Exp_0")
ECL_PRED_INFORMER_PATH = path_parse(
