...
python -u main_informer.py --model winformer --data ECL --root_path ../../dataset --features M --freq h --seq_len 96 --label_len 48 --pred_len 96 --e_layers 2 --d_layers 1 --attn prob --des 'Exp' --itr 1 --batch_size 32
